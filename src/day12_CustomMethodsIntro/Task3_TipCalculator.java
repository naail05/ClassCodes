...
public class Task3_TipCalculator {

    public static void main(String[] args) {

        Scanner input = new Scanner(System.in);
        System.out.println("Split or No split (Yes or No)");
        String yesNo = input.next().toLowerCase();//it will ignore the case sensitivity, the lowercase method
        ...
        String service = input.next().toLowerCase();// to ignore case sensitivity here
        input.close();
        ...
        if(yesNo.equals("yes")){
            System.out.println("Total per person: "+totalPay/numOfPeople);
