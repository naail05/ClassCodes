...
public class CydeoLogin2 {
    ...
    public static void main(String[] args) {
        ...
        if( userN.equals("Cydeo") && pass.equals("WoodenSpoon")){
            System.out.println("Logged in successfully");// if credentials are correct
        }else { //otherwise

            for (int i = 0; i < 3; i++) {
               if(i !=2) {System.err.println("Incorrect username/password, please try again");}else{System.err.println("Incorrect username/password, please try again. warning! if entered incorrect your account will be locked ");}
                System.out.println("Enter your username:");
                userN = input.next();
                System.out.println("Enter your password:");
                pass = input.next();
                ...
                System.err.println("Your account is locked!");}}//this will be executed after three attempts
    input.close();
    }}
