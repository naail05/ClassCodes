...
public class Warmup1 {
    ...
    public static void main(String[] args) {
        ...
        //Write a program that can display the name and job title of each employee
        //to get each element we will use for each loop and then get method to access each element
        ...
        //Write a program that can display the names of "Java Developers"
        for (Employee each : employees) {
...
/*
        ...
        for (int i = 0; i < employees.size(); i++) {
            if(employees.get(i).salary>max){
                max= employees.get(i).salary;}

            if(employees.get(i).salary<min){
...
*/
        ...
        System.out.println("-----------------------------------------------");
//Create two arraylists named femaleEmployees and maleEmployees, write a program that can add all the female employees and male employees to the femaleEmployees and maleEmployees arraylists
       ...
       // System.out.println(maleEmployees); to print the male employee array

        System.out.println("Total number of female employees: " +femaleEmployees.size());
       // System.out.println(femaleEmployees); to print the female employee array
